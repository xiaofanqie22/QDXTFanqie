...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/xiaofanqie22/QDXTFanqie.git"
  ...
  spec.author             = { "baipingdev" => "bp_yacjt@163.com" }
  # Or just: spec.author    = "baipingdev"
  # spec.authors            = { "baipingdev" => "bp_yacjt@163.com" }
  ...
  spec.source       = { :git => "https://github.com/xiaofanqie22/QDXTFanqie.git", :tag => spec.version }
  ...
  #
   ...
   spec.source_files  = "QDXTCocoPods/ygxtClass/ViewController.h"
